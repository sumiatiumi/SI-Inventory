...
class Laporan extends CI_Controller{
    ...
    public function Alatkeluar(){
        ...
        $this->load->view('partial_admin/head', $ttl);
        $this->load->view('admin/laporan/lap_Alatkeluar');   
        $this->load->view('partial_admin/foot');
    }    
    ...
    public function cari_AlatKeluar(){
        ...
        $this->load->view('admin/laporan/hsl_AlatKeluar',$data);
     ...
     public function cetakAlatKeluar(){
        ...
        $this->load->view('admin/laporan/laporanAlatkeluar', $data);
    } 
    ...
    public function Alatmasuk(){
        ...
        $this->session->unset_userdata('tglAkhir');
         ...
         $this->load->view('partial_admin/head', $ttl);
        $this->load->view('admin/laporan/lap_AlatMasuk');   
        $this->load->view('partial_admin/foot');
    }
    ...
    public function cari_AlatMasuk(){
        ...
        $this->load->view('admin/laporan/hsl_AlatMasuk',$data);
    ...
    public function cetakAlatMasuk(){
        ...
        $this->load->view('admin/laporan/laporanAlatmasuk', $data);
    } 
     ...
     public function Bahankeluar(){
        ...
        $this->load->view('partial_admin/head', $ttl);
        $this->load->view('admin/laporan/lap_Bahankeluar');   
        $this->load->view('partial_admin/foot');
    }    
    ...
    public function cari_BahanKeluar(){
        ...
        $this->load->view('admin/laporan/hsl_BahanKeluar',$data);
     ...
     public function cetakBahanKeluar(){
        ...
        $this->load->view('admin/laporan/laporanBahankeluar', $data);
    } 
    ...
    public function Bahanmasuk(){
        ...
        $this->session->unset_userdata('tglAkhir');
         ...
         $this->load->view('partial_admin/head', $ttl);
        $this->load->view('admin/laporan/lap_BahanMasuk');   
        $this->load->view('partial_admin/foot');
    }
    ...
    public function cari_BahanMasuk(){
        ...
        $this->load->view('admin/laporan/hsl_BahanMasuk',$data);
    ...
    public function cetakBahanMasuk(){
        ...
        $this->load->view('admin/laporan/laporanBahanmasuk', $data);
    } 
     ...
     public function Peminjaman(){
        ...
        $this->session->unset_userdata('tglAkhir');
         ...
         $this->load->view('partial_admin/head', $ttl);
        $this->load->view('admin/laporan/lap_Pinjam');   
        $this->load->view('partial_admin/foot');
    }
    ...
    public function cari_lapPinjam(){
        ...
        $this->load->view('admin/laporan/hsl_lapPinjam',$data);
    ...
    public function cetaklapPinjam(){
        ...
        $this->load->view('admin/laporan/laporanPinjam', $data);
    } 
