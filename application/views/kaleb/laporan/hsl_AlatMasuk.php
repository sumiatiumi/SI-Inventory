...
<br>
<div  class="card-footer small text-muted text-center"><a href="<?php echo base_url('kaleb/laporan/cetakAlatMasuk') ?>">
        <button name="submit" type="submit" class="btn btn-primary col-md-2 col-xs-12 ">
            <i class="fa fa-print"></i> Cetak
        </button></a></div>

<div  class="card-footer small text-muted text-center"><a href="<?php echo base_url('kaleb/laporan/Alatmasuk') ?>">
