...
EOD;
    ...
    $table = '<p align="left"> Periode : '.date('d M Y',strtotime($tglAw)).' s/d '.date('d M Y',strtotime($tglAk)).'</p> <table border="1"  cellpadding="0" cellspacing="3" align="center" fontsize="12">';
        $table .= '
            ...
            <th colspan="1" width="80">Nama Barang</th>
            <th colspan="1" width="100">Spesifikasi</th>
            <th colspan="1" width="80">Kondisi</th>
            <th colspan="1" width="60">Jumlah</th>
            <th colspan="1" width="80">Lokasi Tujuan</th>
            <th colspan="1" width="90">Tanggal Keluar</th>
            </tr>
            ';
        $no=1;
        ...
        $table .='
            ...
            <td colspan="1" width="80">'.$keluar->nama_barang.'</td>
            <td colspan="1" width="100">'.$keluar->spesifikasi.'</td>
            <th colspan="1" width="80">'.$keluar->kondisi.'</th>
            <td colspan="1" width="60">'.$keluar->jumlah.'</td>
            <td colspan="1" width="80">'.$keluar->lokasi.'</td>
            <td colspan="1" width="90">'.$keluar->tanggal_keluar.'</td>
            </tr>';
        $no++;
        }
