    ...
    <div class="container-fluid">
        <ol class="breadcrumb">
            <li class="breadcrumb-item active">
                <h5><strong>Konfirmasi Pengembalian</strong></h5>
            </li>
        </ol>

        <form method="post" action="<?php echo base_url('admin/cpeminjaman/konfirmasi_pengembalian/'.$peminjaman['id_peminjaman']) ?>">
            <div class="row">
                <div class="col-sm-6">
